...
<div class="header">
	...
	<div class="header-right">
		<a class="active" accesskey="i" href="index.php">Home</a>
	</div>
</div>
...
<button id='buttonStart' accesskey="S" onclick="startGame(<?php echo "$secondsin"; ?>)">START</button>
<button id='buttonCheck' accesskey="c" onclick="failOrGrace(<?php echo "$numberOfCeldasToIlluminate"; ?>)">CHECK</button>
